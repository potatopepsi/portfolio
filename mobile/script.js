function toggleHidden(){
    ...
    // document.getElementById('sight').style.visibility ='visible';
    // document.getElementById('sight2').style.visibility ='visible';
...
function toggleSight(){
    ...
    // document.getElementById('sight').style.visibility ='hidden';
    // document.getElementById('sight2').style.visibility ='hidden';
